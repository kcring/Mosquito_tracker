...
addpath /Users/sachit/Dropbox/peregrine/TOOLBOX_calib;

%% change these values

% location where intrinsic calibration .mat files are kept
intrlocs=[  '/Users/sachit/Documents/Teaching/2017/Spring/Robot_vision/lectures/camera/material/stereo/left/checkerboard/';
            '/Users/sachit/Documents/Teaching/2017/Spring/Robot_vision/lectures/camera/material/stereo/rght/checkerboard/']; 
            
% corresponding images for extrinsic. the identifiers are used to list the
% image
camid_list=['camL_'; 'camR_'];        
extrimg_loc='/Users/sachit/Documents/Teaching/2017/Spring/Robot_vision/lectures/camera/material/stereo/extr/';
...
for ii=1:nc
    ...
    load(matfile, 'fc','cc','kc','alpha_c', 'dX', 'dY');
    fprintf('dX=%.1f, dY=%.1f\n', dX, dY);
    ...
    for im_ii=1:ni
        ...
        [x_ext,X_ext,n_sq_x,n_sq_y,ind_orig,ind_x,ind_y] = extract_grid(I,wintx,winty,fc,cc,kc, dX, dY);
